...
execute if block ~ ~ ~ blast_furnace unless block ~ ~ ~ blast_furnace{CustomName:'"Rock Crusher"'} unless block ~ ~ ~ blast_furnace{CustomName:'"Rock Crusher - Crushing"'} run tag @s add not_rock_crusher
