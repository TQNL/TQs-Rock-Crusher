...
give @s flower_banner_pattern{display:{Name:'{"text":"Quicksand Bucket","italic":false}',Lore:['{"text":"ferric quicksand"}']},HideFlags:127,CustomModelData:5887432,quicksandbucket:1b} 1
